...
// CREATE TABLE `entries` (`id` BIGINT NOT NULL AUTO_INCREMENT , `entry_key` VARCHAR(255) NOT NULL UNIQUE, value TEXT NOT NULL, expiration INT, PRIMARY KEY (`id`)) ENGINE=InnoDB;
